...
<div class="header">Add new educations </div>
...
<table>
    ...
    <tr>
      <td></td>
      <td><label class="label">Education Name: </label></td>
      <td><input type="text" name="txt_education_name" size="35" /></td>
    </tr>
    ...
    <tr>
      <td></td>
      <td></td>
      <td><input type="submit" name="bt_add" value="Add Education" class="button" /></td>
    </tr>
...
<br /><br />
<div class="page_header">Update educations </div>
...
<div class="page_header">Educations </div>


<a href="?action=add">Add new Education</a>
...
{foreach from=$manage_lists key=k item=i}
  ...
  <tr>
    ...
    <td>
      ...
      <a href="?action=delete&amp;id={$i.id}"  onclick="if ( !confirm('Are you sure you wont to delete this Education name') ) return false;" >
